...
==========
  ...
  Installing and using this library (GFL SDK) signifies acceptance of these terms and conditions of the license.
...
=========
  ...
  PC x86 Windows 9x, Me, Xp, NT & 2000
...
---------
  ...
  PNGLib 1.0.8 - http://www.libpng.org/pub/png/
...
--------
  ...
  Delphi interface              : Ingo Neumann
  Visual Basic interface & ASP  : Jerome Quintard
  Free Pascal interface         : Guus Scholten
